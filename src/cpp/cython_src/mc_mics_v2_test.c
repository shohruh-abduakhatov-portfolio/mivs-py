...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "mivs.src.cython_src.mc_mics_v2_test",
        "sources": [
            "mc_mics_v2_test.pyx"
        ]
    },
    "module_name": "mivs.src.cython_src.mc_mics_v2_test"
}
END: Cython Metadata */
...
#define __PYX_HAVE__mivs__src__cython_src__mc_mics_v2_test
#define __PYX_HAVE_API__mivs__src__cython_src__mc_mics_v2_test
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsds_object(PyObject *, int writable_flag);
...
/* Module declarations from 'mivs.src.cython_src.mc_mics_v2_test' */
...
#define __Pyx_MODULE_NAME "mivs.src.cython_src.mc_mics_v2_test"
extern int __pyx_module_is_main_mivs__src__cython_src__mc_mics_v2_test;
int __pyx_module_is_main_mivs__src__cython_src__mc_mics_v2_test = 0;

/* Implementation of 'mivs.src.cython_src.mc_mics_v2_test' */
...
static const char __pyx_k_mivs_src_cython_src_mc_mics_v2_t[] = "mivs.src.cython_src.mc_mics_v2_test";
...
static PyObject *__pyx_n_s_mivs_src_cython_src_mc_mics_v2_t;
...
static PyObject *__pyx_pf_4mivs_3src_10cython_src_15mc_mics_v2_test_all_diff(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_prod, int __pyx_v_num_sup, int __pyx_v_num_perech, __Pyx_memviewslice __pyx_v_bools_list); /* proto */
...
/* "mivs/src/cython_src/mc_mics_v2_test.pyx":11
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
 * def all_diff(int num_prod, int num_sup, int num_perech, np.ndarray[:,:,:] bools_list):             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[:,:,:] all_diff_arr = np.ndarray[num_prod, num_sup, num_perech]
 *     cdef unsigned int i, j, k, i_in
 */

/* Python wrapper */
static PyObject *__pyx_pw_4mivs_3src_10cython_src_15mc_mics_v2_test_1all_diff(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4mivs_3src_10cython_src_15mc_mics_v2_test_1all_diff = {"all_diff", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4mivs_3src_10cython_src_15mc_mics_v2_test_1all_diff, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4mivs_3src_10cython_src_15mc_mics_v2_test_1all_diff(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_num_prod;
  int __pyx_v_num_sup;
  int __pyx_v_num_perech;
  __Pyx_memviewslice __pyx_v_bools_list = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  ...
  __Pyx_RefNannySetupContext("all_diff (wrapper)", 0);
  {
    ...
    __pyx_v_bools_list = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_object(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_bools_list.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("all_diff", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("mivs.src.cython_src.mc_mics_v2_test.all_diff", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4mivs_3src_10cython_src_15mc_mics_v2_test_all_diff(__pyx_self, __pyx_v_num_prod, __pyx_v_num_sup, __pyx_v_num_perech, __pyx_v_bools_list);
...
static PyObject *__pyx_pf_4mivs_3src_10cython_src_15mc_mics_v2_test_all_diff(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_prod, int __pyx_v_num_sup, int __pyx_v_num_perech, __Pyx_memviewslice __pyx_v_bools_list) {
  __Pyx_memviewslice __pyx_v_all_diff_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":12
 * @cython.wraparound(False)
 * def all_diff(int num_prod, int num_sup, int num_perech, np.ndarray[:,:,:] bools_list):
 *     cdef np.ndarray[:,:,:] all_diff_arr = np.ndarray[num_prod, num_sup, num_perech]             # <<<<<<<<<<<<<<
 *     cdef unsigned int i, j, k, i_in
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_num_sup); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_num_perech); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_ptype_5numpy_ndarray), __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_object(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_all_diff_arr = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":15
 *     cdef unsigned int i, j, k, i_in
 * 
 ...
 */
  __pyx_t_6 = __pyx_v_num_prod;
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "mivs/src/cython_src/mc_mics_v2_test.pyx":16
 * 
 *     for i in range(num_prod):  # per drug
 *         for j in range(num_sup):  # per supplier             # <<<<<<<<<<<<<<
 * #             # Adds an all-different constrai12. Select one price per row of all perechs.
 ...
 */
    __pyx_t_9 = __pyx_v_num_sup;
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "mivs/src/cython_src/mc_mics_v2_test.pyx":19
 * #             # Adds an all-different constrai12. Select one price per row of all perechs.
 * #             # If one perech price is selected -> do not select other perech price variants
 *             for k in range(num_perech + 1):             # <<<<<<<<<<<<<<
 * #                 cdef np.ndarray[:] tmp_arr = np.delete(bools_list[:,j], k, 1).flatten()
 *                 all_diff_arr[i,j,k] = np.delete(bools_list[:,j], k, 1).flatten()
 */
      __pyx_t_12 = (__pyx_v_num_perech + 1);
      __pyx_t_13 = __pyx_t_12;
      for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        __pyx_v_k = __pyx_t_14;

        /* "mivs/src/cython_src/mc_mics_v2_test.pyx":21
 *             for k in range(num_perech + 1):
 * #                 cdef np.ndarray[:] tmp_arr = np.delete(bools_list[:,j], k, 1).flatten()
 *                 all_diff_arr[i,j,k] = np.delete(bools_list[:,j], k, 1).flatten()             # <<<<<<<<<<<<<<
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_delete); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_15.data = __pyx_v_bools_list.data;
        __pyx_t_15.memview = __pyx_v_bools_list.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_15, 0);
        __pyx_t_15.shape[0] = __pyx_v_bools_list.shape[0];
__pyx_t_15.strides[0] = __pyx_v_bools_list.strides[0];
    __pyx_t_15.suboffsets[0] = -1;

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_j;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_bools_list.strides[1];
        if ((0)) __PYX_ERR(0, 21, __pyx_L1_error)
        __pyx_t_15.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_15.shape[1] = __pyx_v_bools_list.shape[2];
__pyx_t_15.strides[1] = __pyx_v_bools_list.strides[2];
    __pyx_t_15.suboffsets[1] = -1;

__pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_15, 2, (PyObject *(*)(char *)) __pyx_memview_get_object, (int (*)(char *, PyObject *)) __pyx_memview_set_object, 1);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __PYX_XDEC_MEMVIEW(&__pyx_t_15, 1);
        __pyx_t_15.memview = NULL;
        __pyx_t_15.data = NULL;
        __pyx_t_16 = __Pyx_PyInt_From_unsigned_int(__pyx_v_k); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 21, __pyx_L1_error)
        ...
        if (PyFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[4] = {__pyx_t_17, __pyx_t_2, __pyx_t_16, __pyx_int_1};
          __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_18, 3+__pyx_t_18); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[4] = {__pyx_t_17, __pyx_t_2, __pyx_t_16, __pyx_int_1};
          __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_18, 3+__pyx_t_18); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_17); __pyx_t_17 = 0;
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        ...
        #endif
        {
          __pyx_t_19 = PyTuple_New(3+__pyx_t_18); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 21, __pyx_L1_error)
          ...
          PyTuple_SET_ITEM(__pyx_t_19, 2+__pyx_t_18, __pyx_int_1);
          __pyx_t_2 = 0;
          __pyx_t_16 = 0;
          __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_19, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
        }
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_flatten); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_4 = NULL;
        ...
        __pyx_t_23 = ((PyArrayObject * *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_all_diff_arr.data + __pyx_t_20 * __pyx_v_all_diff_arr.strides[0]) ) + __pyx_t_21 * __pyx_v_all_diff_arr.strides[1]) ) + __pyx_t_22 * __pyx_v_all_diff_arr.strides[2]) ));
        __Pyx_GOTREF(*__pyx_t_23);
        __Pyx_INCREF(__pyx_t_3); __Pyx_DECREF(*__pyx_t_23);
        *__pyx_t_23 = __pyx_t_3;
        __Pyx_GIVEREF(*__pyx_t_23);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

        /* "mivs/src/cython_src/mc_mics_v2_test.pyx":22
 * #                 cdef np.ndarray[:] tmp_arr = np.delete(bools_list[:,j], k, 1).flatten()
 *                 all_diff_arr[i,j,k] = np.delete(bools_list[:,j], k, 1).flatten()
 *                 for i_in in range(all_diff_arr[i,j,k]):             # <<<<<<<<<<<<<<
 *                     all_diff_arr[i,j,k][i_in] = all_diff_arr[i,j,k][i_in].Not()
 ...
 */
        ...
        __pyx_t_3 = (PyObject *) *((PyArrayObject * *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_all_diff_arr.data + __pyx_t_24 * __pyx_v_all_diff_arr.strides[0]) ) + __pyx_t_25 * __pyx_v_all_diff_arr.strides[1]) ) + __pyx_t_26 * __pyx_v_all_diff_arr.strides[2]) ));
        __Pyx_INCREF((PyObject*)__pyx_t_3);
        __pyx_t_27 = __Pyx_PyInt_As_long(((PyObject *)__pyx_t_3)); if (unlikely((__pyx_t_27 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
        __pyx_t_28 = __pyx_t_27;
        for (__pyx_t_29 = 0; __pyx_t_29 < __pyx_t_28; __pyx_t_29+=1) {
          __pyx_v_i_in = __pyx_t_29;

          /* "mivs/src/cython_src/mc_mics_v2_test.pyx":23
 *                 all_diff_arr[i,j,k] = np.delete(bools_list[:,j], k, 1).flatten()
 *                 for i_in in range(all_diff_arr[i,j,k]):
 *                     all_diff_arr[i,j,k][i_in] = all_diff_arr[i,j,k][i_in].Not()             # <<<<<<<<<<<<<<
 *                     print("as")
 ...
 */
          ...
          __pyx_t_1 = (PyObject *) *((PyArrayObject * *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_all_diff_arr.data + __pyx_t_30 * __pyx_v_all_diff_arr.strides[0]) ) + __pyx_t_31 * __pyx_v_all_diff_arr.strides[1]) ) + __pyx_t_32 * __pyx_v_all_diff_arr.strides[2]) ));
          __Pyx_INCREF((PyObject*)__pyx_t_1);
          __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_t_1), __pyx_v_i_in, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
          __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_Not); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_4 = NULL;
          if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
          ...
          __pyx_t_1 = (PyObject *) *((PyArrayObject * *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_all_diff_arr.data + __pyx_t_33 * __pyx_v_all_diff_arr.strides[0]) ) + __pyx_t_34 * __pyx_v_all_diff_arr.strides[1]) ) + __pyx_t_35 * __pyx_v_all_diff_arr.strides[2]) ));
          __Pyx_INCREF((PyObject*)__pyx_t_1);
          if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_t_1), __pyx_v_i_in, __pyx_t_3, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0) < 0)) __PYX_ERR(0, 23, __pyx_L1_error)
          __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

          /* "mivs/src/cython_src/mc_mics_v2_test.pyx":24
 *                 for i_in in range(all_diff_arr[i,j,k]):
 *                     all_diff_arr[i,j,k][i_in] = all_diff_arr[i,j,k][i_in].Not()
 *                     print("as")             # <<<<<<<<<<<<<<
 * 
 *     return all_diff_arr
 */
          if (__Pyx_PrintOne(0, __pyx_n_s_as) < 0) __PYX_ERR(0, 24, __pyx_L1_error)
        }
      }
    }
  }

  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":26
 *                     print("as")
 * 
 *     return all_diff_arr             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_all_diff_arr, 3, (PyObject *(*)(char *)) __pyx_memview_get_object, (int (*)(char *, PyObject *)) __pyx_memview_set_object, 1);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_all_diff_arr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_bools_list, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "mivs.src.cython_src.mc_mics_v2_test.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "mivs.src.cython_src.mc_mics_v2_test.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "mivs.src.cython_src.mc_mics_v2_test.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "mivs.src.cython_src.mc_mics_v2_test._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mivs_src_cython_src_mc_mics_v2_t, __pyx_k_mivs_src_cython_src_mc_mics_v2_t, sizeof(__pyx_k_mivs_src_cython_src_mc_mics_v2_t), 0, 0, 1, 1},
 ...
 *     cdef unsigned int i, j, k, i_in
 */
  __pyx_tuple__26 = PyTuple_Pack(9, __pyx_n_s_num_prod, __pyx_n_s_num_sup, __pyx_n_s_num_perech, __pyx_n_s_bools_list, __pyx_n_s_all_diff_arr, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_i_in); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mc_mics_v2_test_pyx, __pyx_n_s_all_diff, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 11, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_mivs__src__cython_src__mc_mics_v2_test) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mivs.src.cython_src.mc_mics_v2_test")) {
      if (unlikely(PyDict_SetItemString(modules, "mivs.src.cython_src.mc_mics_v2_test", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * np.get_include()
 * cimport numpy as np
 */
  ...
  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":2
 * import numpy as np
 * np.get_include()             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":5
 * cimport numpy as np
 * cimport cython
 ...
 */
  ...
  /* "mivs/src/cython_src/mc_mics_v2_test.pyx":7
 * from ortools.sat.python import cp_model
 * 
 * model = cp_model.CpModel()             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef unsigned int i, j, k, i_in
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4mivs_3src_10cython_src_15mc_mics_v2_test_1all_diff, NULL, __pyx_n_s_mivs_src_cython_src_mc_mics_v2_t); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mivs.src.cython_src.mc_mics_v2_test", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mivs.src.cython_src.mc_mics_v2_test");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsds_object(PyObject *obj, int writable_flag) {
