...
# from src.data.data_num_mivs_iskan import data as test
# from src.data.data_num_mivs_iskan_feasible import data as test
from src.data.data_num_mivs_iskan_8_optimal import data as test
