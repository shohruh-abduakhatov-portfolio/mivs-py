...
async def main():
    ...
    cash_cost = [
        [6610, 702645, 334348, 549022, 98971, 701367, 516241, 108871, 355646, 278511, 255499, 53295, 193850, 524844,
    ...
    pred_25 = [
        [166926, 177417, 84422, 138628, 24990, 177095, 130350, 27489, 89800, 70324, 64513, 13456, 48947, 132523, 61288,
         82645, 59862],  # prod_A
        [49974, 170120, 42326, 36932, 47515, 30516, 291, 65785, 129994, 103590, 120563, 2841, 123475, 40752, 60093,
         122972, 45107]]
